defmodule MoonUI.Patcher.JSPatcherTest do
  use ExUnit.Case
  ...
  describe "Test JS patcher" do
    test "patch/2 adds new code when JS file is empty" do
      File.write!(@js_file, "")
      File.write!(@code_to_add_file, "console.log('Hello, MoonUI!');")
      ...
      assert patched_content =~ "console.log('Hello, MoonUI!');"
    end
